...
Window WINDOW('Style Checkbox Example'),AT(,,145,224),GRAY,SYSTEM,FONT('Segoe UI',9),ALRT(CtrlShiftW),CENTER
...
Window WINDOW('Style Checkbox List - STRING(1) Z(1)'),AT(,,169,195),GRAY,SYSTEM,FONT('Segoe UI',9),RESIZE,CENTER
...
FC          LONG            
FY          LONG            
Window WINDOW('Style Checkbox List BIG for Touch. Easy to Scale'),AT(,,169,150),GRAY,SYSTEM,FONT('Segoe UI',16,,FONT:regular),RESIZE,CENTER
...
Window WINDOW('Style Checkbox List - String(1) and Byte Index in Queue'),AT(,,264,169),GRAY,SYSTEM,FONT('Segoe UI',9),RESIZE,CENTER
...
Window WINDOW('Style Checkbox List - Q Style Works like Icons - Flexible Window'),AT(,,251,196),GRAY,SYSTEM,FONT('Segoe UI',9),RESIZE,CENTER
        LIST,AT(8,5,150,125),USE(?ListCB),FROM(CheckQ),FORMAT('16C|Y~Tag~@s1@91L(2)|M~Name~@s32@50L(2)|M~Style#~@n3@#2#')
        PROMPT('Check/Icon comes from Style Number in Queue. 2 Styles use @PxP picture to render Checked/Unchecked Symbo' & |
                'ls. This also allows Check/Icon to come from multiple fonts with different colors.<13,10><13,10>Code wo' & |
...
Font        STRING(32)      !DQ:Font
            END
Window WINDOW('Checkbox Character Ideas'),AT(,,200,300),GRAY,SYSTEM,FONT('Segoe UI',9),RESIZE,CENTER
...
DQ:CT       STRING(1+5),DIM(4)
          END            
Window WINDOW('Dingbat Map - Tooltip shows Val() and Chr()'),AT(,,480,300),GRAY,SYSTEM,MAX,FONT('Segoe UI',9),RESIZE,CENTER
